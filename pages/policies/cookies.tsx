...
const Page: React.FunctionComponent = () => (
  <Layout>
    <Head>
      <title>Pepper town: Cookie Policy</title>
    ...
    <section className="py-10">
      <div className="prose mx-auto">
        <h2>Cookie Policy</h2>
        <p>
          We use cookies to help improve your experience of our website at <a href="https://pepper.town">https://pepper.town</a>. This
          cookie policy is part of Pepper Town&#39;s privacy policy. It covers the use of cookies between your device and our site.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          <a href="https://pepper.town">https://pepper.town</a>. In such a case, we may be unable to provide you with some of your desired
        ...
        <p>
          Cookies are used to enable certain features (eg logging in), track site usage (eg analytics), store your user settings (eg time
          zone, notification preferences), and to personalise your content (eg advertising, language).{' '}
        </p>
        <p>
        ...
        <p>
          Essential cookies are crucial to your experience of a website, enabling core features like user logins, account management,
        ...
        <p>
          ...
          visiting (like language and time zone settings). With this information, websites can provide you with customised, enhanced, or
          optimised content and services. These cookies may be set by the website you’re visiting (first-party) or by third-party services.{' '}
        </p>
        ...
        <p>
          ...
          Websites may use them to deliver targeted advertising or limit the number of times you see an advertisement. This helps companies
          improve the effectiveness of their campaigns and the quality of content presented to you. These cookies may be set by the website
          you’re visiting (first-party) or by third-party services. Targeting/advertising cookies set by third-parties may be used to track
